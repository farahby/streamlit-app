...
- LLM: microsoft/Phi-3.5-mini-instruct (4-bit NF4)
  SANS adapter LoRA sur ce run — modele de base uniquement (executer Layer 6B pour entrainer l adapter)
- Risk scoring: XGBoost + LightGBM ensemble, isotonic-calibrated (Layer 5B).
  ...
  proxy). Evaluation: out_of_fold, f1=0.8889 (IC95 0.7949-0.9565) sur n=71 cas.
